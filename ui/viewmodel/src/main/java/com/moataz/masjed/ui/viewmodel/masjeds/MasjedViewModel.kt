...
import com.moataz.masjed.domain.usecases.AddNewMasjedUsecase
...
import com.moataz.masjed.ui.viewmodel.models.mapper.toMasjed
    ...
    private fun getAllMasjeds() {
        viewModelScope.launch {
            try {
                ...
                _masjedsUiState.value = MasjedsUIState(
                    isError = true,
                    isLoading = false,
                    isSuccessful = false,
                    masjeds = listOf(),
